...
class MistralLoader:
    ...
    def __init__(self, llm_config: dict, hf_token: str = None, device: str = 'cpu'): # hf_token aggiunto come parametro
        """
        ...
        """
        self.model_name = llm_config.get("model_name") # or "mistralai/Mistral-7B-Instruct-v0.3"
        ...
        try:
            self.model = AutoModelForCausalLM.from_pretrained(
                ...
                device_map='auto',  ### CHOOSE HERE your HARDWARE GPU/CPU ### 
                token=self.hf_token
            )
