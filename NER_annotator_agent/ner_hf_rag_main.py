...
from pipelines.hf_ner_rag_pipeline import run_pipeline
...
run_pipeline(input_path=input_path,output_path=output_path,checkpoint_path=checkpoint_path,llm_config=llm_config)
